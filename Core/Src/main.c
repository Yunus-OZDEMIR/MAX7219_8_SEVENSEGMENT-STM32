...
/*
 * @DecodeRange
 * Note: DecodeRange value determines digits acording Code B
 */

/*
 * @ScanMode
 * Note: The scan-limit register sets how many digits are displayed,
from 1 to 8.
 */

/*
 * @IntensityValue
 * Note: Display brightness can be controlled
 */
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  Max7219_Init(DecodeRange, ScanMode, IntensityValue);
  /* USER CODE END 2 */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  /*
	 	  ...
	 	  PrintDigit(5, P_letter,DotEn);
	 	  HAL_Delay(500);

	 	  CleanDigits(DecodeRange);

	 	  PrintDigit(4, H_letter,DotDis);
	 	  PrintDigit(3, E_letter,DotDis);
